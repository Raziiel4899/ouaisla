"Resource/UI/ClassMenu.res"
{
	...
	"MiscPanel"
	{
		...
		"randompc"
		{
			...
			"activeimage"		"class_sel_sm_juggernaut_blu"
			"inactiveimage"		"class_sel_sm_juggernaut_inactive"
			
			"teamactiveimage_2" "class_sel_sm_juggernaut_red"
			"teamactiveimage_3" "class_sel_sm_juggernaut_blu"
			"teamactiveimage_4" "class_sel_sm_juggernaut_mercenary"
			
			"teamactiveimage_2" "class_sel_sm_juggernaut_inactive"
			"teamactiveimage_3" "class_sel_sm_juggernaut_inactive"
			"teamactiveimage_4" "class_sel_sm_juggernaut_inactive"
		}
